...
<div class="container">
    ...
    <ol class="breadcrumb">
        <li><a href="client_home.ftl">Admin</a></li>
        <li class="active">Add comics</li>
    </ol>
    ...
    <div class="row">
        ...
        <article class="col-xs-12 maincontent">
            <header class="page-header">
                <h1 class="page-title">Add new comics</h1>
            </header>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form class="form-signin" method="post" id="reg_form">
                            ...
                            <input type="text" id="adress" class="form-control" placeholder="Address"
                            ...
                            <input type="text" id="lease" class="form-control" placeholder="Lease"
                                   name="lease" required>
                            <hr>

                            <label><input type="submit" class="btn btn-action btn-lg" role="button" value="Add shop"/></label>
                            <br>
