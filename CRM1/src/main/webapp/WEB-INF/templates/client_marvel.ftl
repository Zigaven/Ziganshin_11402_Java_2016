				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li class="active"><a href="/client/marvel">MARVEL</a></li>
		...
		<div class="row">
			...
			<aside class="col-md-4 sidebar sidebar-left">
				...
				<div class="row widget">
					<div class="col-xs-12">
						...
						<p>The company Marvel Comics has created an authoritative publisher of magazines Pulp- Martin Goodman in 1939 as a group of subsidiaries under the title «Timely Comics». The first publication was a comic «Marvel Comics» # 1 (October 1939)</p>
					</div>
				</div>
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Great Martin Goodman</h4>
						<p><img src="/images/2.jpg" alt=""></p>
					</div>
				</div>
				<div class="row widget">
					<div class="col-xs-12">
						<h4>Great Stan Lee</h4>
						<p><img src="/images/1.jpg" alt=""></p>
						<p>The famous American writer, actor, producer, editor and creator of many comic characters, as well as the former president and chairman of the board of directors of the famous publishing house «Marvel Comics»</p>
					</div>
				</div>
			...
			<article class="col-md-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Captain America or Iron Man? Choose!</h1>
				</header>
				...
				<h2>When will release Inhumans?</h2>
				...
				<blockquote>"Captain America: Civil War" will be the best film of Marvel Studious</blockquote>
				...
				<h3>Netflix tell about them new serial is "The Punisher"</h3>
